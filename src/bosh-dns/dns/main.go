...
func mainExitCode() int {
	...
	recursorPool := handlers.NewFailoverRecursorPool(config.Recursors, config.RecursorSelection, config.RecursorRetryCount, time.Duration(config.RecursorRetryDelay), logger)
